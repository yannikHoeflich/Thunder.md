...
public class GraphicsIndex: IndexCanvas{
    protected override IReadOnlyCollection<ThunderIndexItem> GetItems(ThunderConfig config, IThunderBuildState state, IContainer container) => state.OfGroup(ThunderBuildState.FigureGroup);
}
...
public class ThunderBuildState{
    ...
    public ThunderIndexItem GetNextGraphicsName(string name){
        var numberingConfig = _config.Project!.GraphicsNumbering;
        return GetNextFromCounter(numberingConfig, _graphicsCounter++, name, "GRAPH", _graphicsItems);
    }
    public ThunderIndexItem GetNextMathName(){
        var numberingConfig = _config.Project!.MathNumbering;
        return GetNextFromCounter(numberingConfig, _mathCounter++, "", "MATH", _mathItems);
    }
    public ThunderIndexItem GetNextTableName(string name){
        var numberingConfig = _config.Project!.TableNumbering;
        return GetNextFromCounter(numberingConfig, _tableCounter++, name, "TABLE", _tableItems);
    }
    ...
    public bool TryGetCitation(string label, [NotNullWhen(true)] out Citation? citation){
        ...
        citation = new Citation(label, reference, publication);
        return true;
    }
